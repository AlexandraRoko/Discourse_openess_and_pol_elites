...
chisq.test(DATA_FIN$sex, DATA_FIN$resonance, correct=FALSE)
chisq.test(DATA_FIN$sex, DATA_FIN$novelty, correct=FALSE)

chisq.test(top50speaker_by_mean_resonance_meta$PART_OF_GER, top50speaker_by_mean_resonance_meta$resonance, correct=FALSE)
chisq.test(top50speaker_by_mean_novelty_meta$PART_OF_GER, top50speaker_by_mean_novelty_meta$novelty, correct=FALSE)

chisq.test(top50speaker_by_mean_resonance_meta_WP$AGE_CAT, top50speaker_by_mean_resonance_meta_WP$resonance, correct=FALSE)
chisq.test(top50speaker_by_mean_resonance_meta_WP$AGE_CAT, top50speaker_by_mean_resonance_meta_WP$novelty, correct=FALSE)
...
freq(top50speaker_by_mean_resonance_meta$ROLE)
...
colnames(top50speaker_by_mean_resonance_meta)

descr(top50speaker_by_mean_resonance_meta$AGE_CAT)
...
# #AGETABLE_ov_inter <- rename(AGETABLE_ov_inter, Freq = Freq_ov)
# AGETABLE_ov_inter$Var3 <- "NA"
# descr(AGETABLE_ov_inter$Var2)
# AGETABLE_ov_inter$Var3[AGETABLE_ov_inter$Var2 == "36-45"] <- "36-45_ov"
# AGETABLE_ov_inter$Var3[AGETABLE_ov_inter$Var2 == "46-55"] <- "46-55_ov"
# AGETABLE_ov_inter$Var3[AGETABLE_ov_inter$Var2 == "56-65"] <- "56-65_ov"
# AGETABLE_ov_inter$Var3[AGETABLE_ov_inter$Var2 == "older 65"] <- "older 65_ov"
# AGETABLE_ov_inter$Var3[AGETABLE_ov_inter$Var2 == "younger 36"] <- "younger 36_ov"
# AGETABLE_ov_inter$Var3 <- as.factor(AGETABLE_ov_inter$Var3)
# AGETABLE_ov_inter$Var2 <- NULL
# AGETABLE_ov_inter <- rename(AGETABLE_ov_inter, Var2 = Var3)#, Percent = Percent_ov)
# 
# colnames(AGETABLE_ov_inter)
# 
# AGETABLE_bind <- rbind(AGETABLE_ov_inter, AGETABLE)
# AGETABLE_bind$Var2 <- as.factor(AGETABLE_bind$Var2)
# 
# AGETABLE_bind %>%
#   arrange(Freq) %>%
#   mutate(Var2 = factor(Var2, levels=c("younger 36", "younger 36_ov", "36-45", "36-45_ov", "46-55", "46-55_ov", "56-65", "56-65_ov", "older 65", "older 65_ov"))) %>%
#   ggplot( aes(fill=Var2, y=Freq, x=Var1)) +
#   geom_bar(position="dodge", stat="identity")+
#   theme_bw() +
#   xlab("") +
#   scale_x_discrete(breaks = c(12, 13, 14, 15, 16, 17, 18, 19), labels = c("1990-1994", "1994-1998", "1998-2002", "2002-2005", "2005-2009", "2009-2013", "2013-2017", "2017-2021")) +
#   scale_fill_manual(name="Age category",
#                     labels = c("younger 36", "younger 36 - expected",
#                                "36-45", "36-45 - expected",
#                                "46-55", "46-55 - expected",
#                                "56-65", "56-65 - expected",
#                                "older 65", "older 65 - expected"),
#                     values = alpha(c("younger 36" = "#F39C12",
#                                      "younger 36_ov" = "#FAD7A0",
#                                      "36-45" = "#A93226",
#                                      "36-45_ov" = "#F5B7B1",
#                                      "46-55" = "#633974",
#                                      "46-55_ov" = "#E8DAEF",
...
#                                      "56-65_ov" = "#A9CCE3",
#                                      "older 65" = "#196F3D",
#                                      "older 65_ov" = "#A9DFBF"), .9)) + #+# +
#   labs(title="Age shares among speakers in the top 50 speakers for resonance",
#        subtitle = "data demeaned per electoral term",
#        y="Share of contibutions",
#        x = "Electoral term")
