# '''
# ------------------------------------------------------------------------
# Script name: helpers.R
# Purpose of script: helper functions for plotting
# Dependencies: none
...
colour_sheme_gender = c("#52BE80", "#145A32", "#3498DB", "#1F618D")
colour_sheme_ethn = c("#52BE80", "#F39C12",  "#AAB7B8","#1F618D")
...
#from https://stackoverflow.com/questions/52665619/how-to-change-the-position-of-the-zoomed-area-from-facet-zoom
...
#From : https://github.com/wilkelab/ungeviz/blob/master/R/geom_hpline.R
