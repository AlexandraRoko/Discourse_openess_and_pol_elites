...
# input directory
CONTRIBUTIONS_EXTENDED_INPUT = PATH + "output/04_contributions_extended/stage_1"
FACTIONS = PATH + "output/XX_finals"

# output directory
CONTRIBUTIONS_EXTENDED_OUTPUT = PATH + "output/04_contributions_extended/stage_2"
