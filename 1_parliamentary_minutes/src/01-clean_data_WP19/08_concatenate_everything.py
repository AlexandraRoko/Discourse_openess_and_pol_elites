...
SPEECH_CONTENT_INPUT = PATH + "output/01_speeches/stage_4"
CONTRIBUTIONS_EXTENDED_INPUT = PATH + "output/04_contributions_extended/stage_3"

# output directory
SPEECH_CONTENT_OUTPUT = PATH + "output/XX_finals"
CONTRIBUTIONS_EXTENDED_OUTPUT = PATH + "output/XX_finals"
